...
df_good = pd.read_csv("plank_data_good.csv")
df_back = pd.read_csv("plank_data_bad_back.csv")
df_hip  = pd.read_csv("plank_data_bad_hip.csv")

df_good["label"] = "plank_good"
df_back["label"] = "plank_bad_back"
df_hip["label"]  = "plank_bad_hip"


df = pd.concat([df_good, df_back, df_hip], ignore_index=True)
...
joblib.dump(best["model"], "plank_model.pkl")
joblib.dump(le,            "plank_label_encoder.pkl")
print("✓ บันทึก plank_model.pkl และ plank_label_encoder.pkl สำเร็จ")